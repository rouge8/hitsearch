# Taken largely from http://flask.pocoo.org/docs/patterns/sqlalchemy/
# The beautiful thing is that this will all work even if we don't use Flask.

from sqlalchemy import create_engine
from sqlalchemy.orgm import scoped_session, sessionmaker
from sqlalchemy.ext.declarative import declarative_base

engine = create_engin('sqlite:///hitsearch.db', convert_unicode=True)
